...
"""
Using the plotter:
python plot.py data/sb_no_rtg_dna_CartPole-v0_19-09-2017_10-30-13 data/sb_rtg_dna_CartPole-v0_19-09-2017_10-34-05 data/sb_rtg_na_CartPole-v0_19-09-2017_10-35-51 --value AverageReturn  
...
def plot_data(data, value=["AverageReturn"]):
    ...
    ax = data.plot(x = 'Iteration', y = value, grid = True)
